/*!=========================================================
* bootstrap-lightbox v0.4.1 - 12/12/2012
 ...
 * ========================= */
	...
	Lightbox.prototype = {
		...
		centerImage: function()
		{
			...
			var $outerContainer = that.$element;
			var $container = $outerContainer.find('.lightbox-content')
			...
			var $caption = $img.siblings('.lightbox-caption2');
			if($caption.length > 0)
			{
				imageHeight += $caption.height();
			}

			if(that.options.resizeToFit)
			{
				var wOffset = 80 + containerRightPadding + containerLeftPadding;
				var hOffset = 80 + containerTopPadding + containerBottomPadding;

				if(imageWidth > ($(window).width() - wOffset))
					imageWidth = $(window).width() - wOffset ;

				if(imageHeight > ($(window).height() - hOffset))
					imageHeight = $(window).height() - hOffset;
			}
